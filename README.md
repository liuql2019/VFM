...
In order to generate metagenomic bins, binning tools such as [COCACOLA]() should be applied to metagenomic contigs.Then run script bin-VFM_predict.py to predict the bins.
